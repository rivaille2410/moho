...
function Toast({
  ...
  const typeStyle = toastItem?.type
    ? toastTypeStyles[toastItem.type]
    : undefined;
...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  const colorClass = type ? toastTypeStyles[type]?.icon : undefined;
      ...
      <Toast key={toastItem.id} toast={toastItem}>
        <ToastContent>
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-1">
            <ToastTitle className={typeStyle?.title} />
            <ToastDescription className={typeStyle?.description} />
          </div>
          <ToastAction />
          <ToastClose />
        </ToastContent>
