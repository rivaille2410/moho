...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "flex items-center rounded-sm p-1 text-sm font-medium outline-hidden select-none hover:bg-muted aria-expanded:bg-muted transition",
        className,
      )}
      {...props}
    />
